...
IonicTask.prototype.getVersionData = function(version) {
  ...
  request({ url: url, proxy: proxy }, function(err, res, body) {
    try {
      ...
      self.versionData = {
        "version_number": self.versionData.version_number || self.versionData.version,
        "version_codename": self.versionData.version_codename || self.versionData.codename,
        "release_date": self.versionData.release_date || self.versionData.date
      };
